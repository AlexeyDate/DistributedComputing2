...
data = np.loadtxt(time, delimiter=',')
...
rowsTime = 'Multiplication by rows time(seconds)'
rowsAcc = 'Multiplication by rows acceleration'
rowsEff = 'Multiplication by rows efficiency'
